...
<form method="post" action="update.php">
    ...
    <div class="form-group row">
      ...
      <div class="col-8">
        <input id="kul" name="OzelAd" value="<?php echo $row['OzelAd'];?>" placeholder="Özellik Adı" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="sifre" class="col-4 col-form-label">Özel Simge Girin</label> 
      <div class="col-8">
